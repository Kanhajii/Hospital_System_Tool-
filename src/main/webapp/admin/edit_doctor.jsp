...
<%@page import="com.entity.Spacalist"%>
<%@page import="java.util.List"%>
<%@page import="com.db.DbConnect"%>
<%@page import="com.dao.SpacialistDao"%>
						...
						<form action="../updateDoctor" method="post">
							<div class="mb-3">
								<label class="form-label">Full Name</label> <input type="text"
									value="<%=d.getFullname()%>" name="fullname" class="form-control">
							</div>
							...
							<div class="mb-3">
								<label class="form-label">Specialist</label> <select name="spec"
									...
									List<Spacalist> list = dao.getAllSpacalist();
									for (Spacalist s : list) {
									%>
